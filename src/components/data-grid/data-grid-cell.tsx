...
export const DataGridCell = React.memo(DataGridCellImpl, (prev, next) => {
  ...
  let prevValue = (prev.cell.row.original as Record<string, unknown>)[prev.columnId];
  let nextValue = (next.cell.row.original as Record<string, unknown>)[next.columnId];
  
  if (prevValue === undefined && nextValue === undefined) {
    prevValue = prev.cell.getValue();
    nextValue = next.cell.getValue();
  }
