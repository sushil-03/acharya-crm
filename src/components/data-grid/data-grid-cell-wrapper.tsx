...
export function DataGridCellWrapper<TData>({
  ...
  return (
    <div
      ...
      ref={composedRef}
      className={cn(
        "size-full text-start text-sm outline-none",
        {
          "px-2 has-data-[slot=checkbox]:pt-2.5": !(cell.column.columnDef.meta?.cell?.variant === "custom" && cell.column.columnDef.meta?.cell?.noPadding),
          "py-1.5": !(cell.column.columnDef.meta?.cell?.variant === "custom" && cell.column.columnDef.meta?.cell?.noPadding),
